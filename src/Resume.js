        ...
        return (
            ...
            <Row className='experience'>
                <Col s={12}>
                    ...
                    <Row>
                        <Col s={4}>
                        <i class="fa fa-database fa-3x iconStyle" aria-hidden="true"></i>
                        <ul>
                        ...
                        <Col s={4}>
                        <i class="fa fa-laptop fa-3x iconStyle" aria-hidden="true"></i>
                        <ul>
                        ...
                        <Col s={4}>
                        <i class="fa fa-code fa-3x iconStyle" aria-hidden="true"></i>
                        <ul>
